...
extern void SysDisplay_RawCharacter(const char ch, unsigned uiAttr, boolean bUpdateCursorOnScreen) ;
...
OFFSET_TYPE_T ftell(register FILE *stream) ;
int fseek(register FILE *stream, OFFSET_TYPE_T offset, int whence) ;
...
int MOSFixMe(const char * __restrict format, ...) ;
